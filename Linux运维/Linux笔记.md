...
GPT（全局唯一标示）分区表：GPTzhv吃9.4ZB硬盘，理论上支持的分区数没有限制，但Windows限制128个主分区
...
* 针对的都是分区，将分区==划分成等大小的数据块（block）==，数据块在Linux中默认为4KB
...
![image-20201015205421359](Linux笔记.assets/image-20201015205421359.png)
